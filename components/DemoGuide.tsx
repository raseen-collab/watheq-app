...
const STEPS: Step[] = [
  ...
  { title: "كل عقاراتك في صفحة",
    body: "بدّل بين العقارات الخمسة من القائمة أعلى الجدول. وفي حسابك الحقيقي تجد «نظرة عامة» تجمع المحفظة كلها: من تأخر في أي عقار، والدخل المتوقع، وبحث في كل وحداتك.",
    action: { label: "فهمت — التالي", event: "next" } },
  { title: "جاهز لبياناتك؟ 🎯",
